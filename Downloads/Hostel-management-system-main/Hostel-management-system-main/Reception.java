...
btnNewButton_4.addActionListener(new ActionListener() {
    public void actionPerformed(ActionEvent e) {
        // Create an instance of CancelPanel and switch the visibility of the frames
        Node[] head = new Node[3];
        String[][] name_save = new String[3][3];

        JFrame cancelFrame = new JFrame("Cancel Booking");
        cancelFrame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        CancelPanel cancelPanel = new CancelPanel(head, name_save);
